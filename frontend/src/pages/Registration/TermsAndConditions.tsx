...
export const TermsAndConditions = ({ isOpen, onClose }: Props) => (
  <Dialog open={isOpen} scroll="paper" onClose={onClose}>
    <DialogTitle>Terms and Conditions</DialogTitle>
    <DialogContent>
      <p>Welcome to Video sharing platform!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of AEZAKMI's Website, located at aezakmi.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Video sharing platform if you do not
      ...
      <p>
        ...
        subject to, prevailing law of lt. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing Video sharing platform, you
        agreed to use cookies in agreement with the AEZAKMI's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, AEZAKMI and/or its licensors own the
        intellectual property rights for all material on Video sharing platform.
        All intellectual property rights are reserved. You may access this from
        Video sharing platform for your own personal use subjected to
        restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Video sharing platform</li>
        <li>Sell, rent or sub-license material from Video sharing platform</li>
        <li>
          Reproduce, duplicate or copy material from Video sharing platform
        </li>
        <li>Redistribute content from Video sharing platform</li>
      </ul>
      ...
      <p>
        ...
        AEZAKMI does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of AEZAKMI,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, AEZAKMI shall not be liable for the
      ...
      <p>
        AEZAKMI reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant AEZAKMI a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of AEZAKMI; and (d) the link is in
      ...
      <p>
        ...
        e-mail to AEZAKMI. Please include your name, your organization name,
      ...
      <p>
        No use of AEZAKMI's logo or other artwork will be allowed for linking
